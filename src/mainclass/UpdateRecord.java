...
public class UpdateRecord implements ActionListener{
    ...
    String str1,str2,str3,str4,str5,str6,str7,str8,str9,str10,str11;//tf14 for str10//tf10 for str11
    public UpdateRecord()
    {
        try { 
        ...
        JLabel l2=new JLabel("Update Record");
    ...
    public static void main(String[] args) {
       ...
       UpdateRecord a1=new UpdateRecord();
    }
